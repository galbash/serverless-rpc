...
export class TLambdaConnection extends EventEmitter {
  ...
  constructor(connectOptions) {
    ...
    this.#lambdaClient = new AWS.Lambda(this.#clientOptions);
  }
   ...
   * @throws {Error} synchronous errors raised from the Lambda client are rethrown.
   * @return {Promise} resolves when a response from the server has been received.
